...
interface Promotion {
  id: number; promotionId: string; name: string; description: string; type: PromotionType; status: PromotionStatus; priority: number; target: string; startDate: string; endDate: string; usage: string; createdBy: string; createdAt: string
