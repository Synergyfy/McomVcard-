    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                <Link to="/business/vcards" className="hover:text-orange-600">My Business VCards</Link>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5">
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2 flex-wrap shrink-0">
                        ...
                        <Link to="/business/vcards" className="px-3 py-1.5 rounded-lg border border-gray-200 dark:border-gray-600 text-xs font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">Change Template</Link>
                        ...
                        <Link to={`/business/vcards/${vcard.id}/edit`} className="px-3 py-1.5 rounded-lg bg-orange-500 text-white text-xs font-semibold hover:bg-orange-600">Edit Content</Link>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
                ...
                <div className="lg:col-span-2 space-y-5">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-4">
                        ...
                        <Link to={`/business/vcards/${vcard.id}/edit`} className="w-full inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-orange-500 text-white text-[10px] font-semibold hover:bg-orange-600">
                        ...
                        <div className="rounded-lg bg-gray-50 dark:bg-gray-700/30 border border-gray-100 dark:border-gray-700 p-3">
                            <div className="flex items-center justify-between gap-2">
                                ...
                                <div className="flex items-center gap-1.5 shrink-0">
                                    ...
                                    <Link to={`/business/vcards/${vcard.id}/edit`} className="px-2.5 py-1.5 rounded-lg bg-orange-500 text-white text-[10px] font-semibold hover:bg-orange-600 shrink-0">Manage</Link>
                                </div>
                            </div>
                        </div>
                    </div>
