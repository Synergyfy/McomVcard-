...
const groups: Group[] = [
    ...
    },
    {
        ...
        items: [
            { label: 'Template', subtitle: 'Choose your VCard style', action: 'link', to: '/business/cards' },
            ...
            { label: 'QR', subtitle: 'Your VCard QR code', action: 'link', to: '/business/qr' },
        ],
    },
    {
        title: 'Business Card',
        ...
        items: [
            { label: 'Template', subtitle: 'Choose your card style', action: 'link', to: '/business/cards' },
            { label: 'Visibility', subtitle: 'Who can see your card' },
            { label: 'QR', subtitle: 'Where your QR points to', action: 'link', to: '/business/qr' },
    ...
    },
    {
        ...
        items: [
            { label: 'Reward preferences', subtitle: 'Points, coupons, cashback', action: 'link', to: '/business/rewards' },
    ...
    },
    {
        ...
        items: [
            { label: 'MCOM Solutions', subtitle: 'Connected MCOM platform services', action: 'link', to: '/business/integrations' },
            { label: 'MCOM Rewards', subtitle: 'Points, coupons & cashback', action: 'link', to: '/business/integrations' },
            { label: 'MCOMMall', subtitle: 'List products for sale', action: 'link', to: '/business/integrations' },
