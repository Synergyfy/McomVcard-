...
export interface MockConsumer {
  ...
  savedCards: { id: number; name: string; business: string; type: string; source?: string; editable?: boolean }[]
  ...
  additionalCards: { id: number; name: string; relationship: string; status: string; locked: boolean; allocatedAt: string }[]
  shareContent: { id: number; title: string; source: string; status: string; availableUntil: string }[]
...
export const mockConsumers: MockConsumer[] = [
  {
    ...
    recentActivity: [{ action: 'Shared card via WhatsApp', time: '5 min ago', type: 'referral', status: 'Completed', detailTo: '/consumer/cards' }, { action: 'Opened your VCard from a shared link', time: '30 min ago', type: 'vcard', status: 'Completed', source: 'MCOMVCard', detailTo: '/consumer/vcard' }, { action: 'Received £2 cashback from GreenLeaf Coffee', time: '2 hours ago', type: 'earn', status: 'Completed', value: '+£2.00', source: 'GreenLeaf Coffee' }, { action: 'Wallet funded with £10.00', time: '5 hours ago', type: 'funding', status: 'Completed', value: '+£10.00', source: 'Stripe', detailTo: '/consumer/wallet' }, { action: 'Redeemed "Free Coffee" voucher', time: '1 day ago', type: 'reward', status: 'Completed', value: '−200 pts', source: 'GreenLeaf Coffee', detailTo: '/consumer/rewards' }, { action: 'Exchanged a coupon at FitLife Studio', time: '2 days ago', type: 'exchange', status: 'Completed', value: '1 coupon', source: 'FitLife Studio' }, { action: 'Family card updated for Sarah Anderson', time: '3 days ago', type: 'family', status: 'Completed', source: 'Family', detailTo: '/consumer/family' }, { action: 'Completed NFC tap at GreenLeaf Coffee', time: '4 days ago', type: 'nfc', status: 'Completed', source: 'GreenLeaf Coffee' }, { action: 'Membership tier reviewed — Bronze Pro', time: '5 days ago', type: 'membership', status: 'Completed', source: 'MCOMVCard', detailTo: '/consumer/membership' }, { action: 'Joined Summer Savings campaign', time: '6 days ago', type: 'campaign', status: 'Active', value: '+50 pts', source: 'GreenLeaf Coffee' }],
...
export const mockConsumerNotifications: ConsumerNotification[] = [
  ...
  { id: 4, title: 'Voucher Expires Tomorrow', message: 'Your "Free Coffee" voucher expires tomorrow. Use it today!', time: '1 day ago', type: 'voucher', read: false, icon: 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z', color: 'text-amber-600 bg-amber-50 dark:bg-amber-900/20', action: { label: 'Use Voucher', to: '/consumer/wallet' } },
  { id: 5, title: 'Family Card Active', message: 'Sarah\'s family card is now active and ready to use', time: '2 days ago', type: 'family', read: true, icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z', color: 'text-blue-600 bg-blue-50 dark:bg-blue-900/20', action: { label: 'View Family', to: '/consumer/family' } },
]
