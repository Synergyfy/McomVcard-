...
export interface MockConsumer {
  ...
  joined: string
  wallet: { balance: number; points: number; cashback: number; giftCards: number; coupons: number; vouchers: number }
  stats: { cards: number; rewards: number; referrals: number; scans: number }
  savedCards: { id: number; name: string; business: string; type: string }[]
  rewardHistory: { id: number; reward: string; points: number; date: string; status: string }[]
...
export const mockConsumers: MockConsumer[] = [
  { id: 1, name: 'Emma Rodriguez', email: 'emma.r@email.com', phone: '+1 (555) 111-2222', location: 'Austin, TX', status: 'active', joined: 'Jan 2026', wallet: { balance: 1280, points: 4500, cashback: 320, giftCards: 2, coupons: 1, vouchers: 0 }, stats: { cards: 3, rewards: 5, referrals: 2, scans: 180 },
    savedCards: [{ id: 1, name: "Emma's Card", business: 'GreenLeaf Coffee', type: 'Loyalty' }, { id: 2, name: 'FitLife Pass', business: 'FitLife Studio', type: 'Membership' }, { id: 3, name: 'Bloom Beauty', business: 'Bloom Beauty Salon', type: 'Rewards' }],
    ...
    recentActivity: [{ action: 'Redeemed "Free Coffee" at GreenLeaf Coffee', time: '1 hour ago', type: 'reward' }, { action: 'Earned 50 points from GreenLeaf Coffee visit', time: '3 hours ago', type: 'earn' }, { action: 'Referred friend - Tom Wilson joined', time: '1 day ago', type: 'referral' }, { action: 'Saved new card "Bloom Beauty"', time: '2 days ago', type: 'card' }, { action: 'Completed NFC tap at FitLife Studio', time: '3 days ago', type: 'nfc' }] },
  { id: 2, name: 'James Chen', email: 'james.c@email.com', phone: '+1 (555) 222-3333', location: 'San Francisco, CA', status: 'active', joined: 'Mar 2025', wallet: { balance: 3420, points: 12000, cashback: 890, giftCards: 5, coupons: 3, vouchers: 1 }, stats: { cards: 7, rewards: 12, referrals: 5, scans: 520 },
  ...
  { id: 3, name: 'Sarah Wilson', email: 'sarah.w@email.com', phone: '+1 (555) 333-4444', location: 'Chicago, IL', status: 'active', joined: 'Jun 2026', wallet: { balance: 560, points: 1800, cashback: 90, giftCards: 0, coupons: 0, vouchers: 0 }, stats: { cards: 1, rewards: 2, referrals: 0, scans: 45 },
  ...
  { id: 4, name: 'Mike Patel', email: 'mike.p@email.com', phone: '+1 (555) 987-6543', location: 'Brooklyn, NY', status: 'active', joined: 'Feb 2026', wallet: { balance: 8900, points: 25000, cashback: 1200, giftCards: 3, coupons: 4, vouchers: 2 }, stats: { cards: 4, rewards: 8, referrals: 3, scans: 340 },
  ...
  { id: 5, name: 'Lisa Thompson', email: 'lisa.t@email.com', phone: '+1 (555) 444-5555', location: 'Denver, CO', status: 'inactive', joined: 'Apr 2026', wallet: { balance: 0, points: 200, cashback: 0, giftCards: 0, coupons: 0, vouchers: 0 }, stats: { cards: 1, rewards: 0, referrals: 0, scans: 12 },
  ...
  { id: 6, name: 'David Kim', email: 'david.k@email.com', phone: '+1 (555) 555-6666', location: 'Seattle, WA', status: 'active', joined: 'Oct 2025', wallet: { balance: 2100, points: 8000, cashback: 450, giftCards: 1, coupons: 2, vouchers: 0 }, stats: { cards: 2, rewards: 3, referrals: 1, scans: 210 },
  ...
  { id: 7, name: 'Anna Martinez', email: 'anna.m@email.com', phone: '+1 (555) 666-7777', location: 'Miami, FL', status: 'active', joined: 'Dec 2024', wallet: { balance: 15000, points: 45000, cashback: 3200, giftCards: 8, coupons: 5, vouchers: 3 }, stats: { cards: 10, rewards: 25, referrals: 8, scans: 1200 },
    savedCards: Array.from({ length: 10 }, (_, i) => ({ id: 100 + i, name: `Card ${i + 1}`, business: ['GreenLeaf Coffee', 'FitLife Studio', 'Bloom Beauty', 'TechVision Inc', 'Coastal Realty', 'Hotel Splendido', 'Elite Barber Co', 'Dr. Smith Dentistry', 'Pizza Roma', 'Swift Legal LLP'][i], type: ['Loyalty', 'Membership', 'Rewards', 'Business', 'Business', 'Membership', 'Loyalty', 'Appointment', 'Loyalty', 'Business'][i] })),
    rewardHistory: Array.from({ length: 25 }, (_, i) => ({ id: 200 + i, reward: ['Free Coffee', 'Cashback $10', 'Premium Upgrade', 'Free Session', 'Gift Card $25', 'VIP Access', 'Birthday Bonus', '20% Discount', 'Free Night Stay', 'Spa Package'][i % 10], points: [200, 1000, 3000, 1500, 2500, 5000, 1000, 2000, 10000, 4000][i % 10], date: ['2026-06-15', '2026-06-10', '2026-06-05', '2026-05-28', '2026-05-20', '2026-05-15', '2026-05-10', '2026-05-01', '2026-04-20', '2026-04-10'][i % 10], status: (['redeemed', 'available', 'expired'] as const)[i % 3] })),
  ...
  { id: 8, name: 'Tom Baker', email: 'tom.b@email.com', phone: '+1 (555) 777-8888', location: 'Portland, OR', status: 'suspended', joined: 'Mar 2026', wallet: { balance: 450, points: 1200, cashback: 80, giftCards: 0, coupons: 0, vouchers: 0 }, stats: { cards: 2, rewards: 1, referrals: 0, scans: 34 },
  ...
  { id: 9, name: 'Sophie Laurent', email: 'sophie.l@email.com', phone: '+1 (555) 888-9999', location: 'Montreal, QC', status: 'active', joined: 'May 2026', wallet: { balance: 2800, points: 9200, cashback: 650, giftCards: 2, coupons: 1, vouchers: 0 }, stats: { cards: 4, rewards: 6, referrals: 2, scans: 165 },
  ...
  { id: 10, name: 'Oscar Hernandez', email: 'oscar.h@email.com', phone: '+1 (555) 999-0000', location: 'Los Angeles, CA', status: 'active', joined: 'Sep 2025', wallet: { balance: 5600, points: 18000, cashback: 1400, giftCards: 4, coupons: 2, vouchers: 1 }, stats: { cards: 6, rewards: 10, referrals: 4, scans: 680 },
...
export interface MockCardDesign {
  id: number; name: string; type: 'Business' | 'Consumer'; style: string
...
export interface CardBusinessBrief {
  id: number; name: string; industry: string; owner: string; email: string; phone: string; active: boolean; cardDesignId: number
}
