...
const navItems: NavItem[] = [
    ...
    { to: '/consumer/activity', label: 'Activity', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
    { to: '/consumer/family', label: 'Friends & Family', icon: 'M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z' },
    { to: '/consumer/membership', label: 'Membership', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
    { to: '/consumer/notifications', label: 'Notifications', icon: 'M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9' },
...
export default function ConsumerSideNav() {
    return (
        <div className="flex flex-col h-full">
            <Link to="/consumer" className="flex items-center gap-2.5 px-5 h-16 border-b border-gray-100 dark:border-gray-800 shrink-0">
            ...
            <div className="p-3 border-t border-gray-100 dark:border-gray-800 shrink-0">
                <Link to="/consumer/settings" className="flex items-center gap-3 p-3 rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
