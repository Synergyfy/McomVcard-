...
interface RuleData {
  id: number; ruleId: string; name: string; qrType: string; owner: string; currentDestination: string; ruleType: string; priority: number; status: string; effectiveDate: string; endDate: string; lastValidation: string; linkedQR: string; linkedOwnerId: string; fallback: string; schedule: { start: string; end: string; destination: string }[]; createdAt: string; updatedAt: string;
}
