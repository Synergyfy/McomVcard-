...
interface CampaignData {
  id: string; campaignId: string; name: string; type: string; owner: string; status: string; qrCodes: number; startDate: string; endDate: string; scans: number; conversionRate: number; engagementRate: number; campaignManager: string; lastUpdated: string; objective: string; successCriteria: string; destination: string; audience: string; color: string; template: string; topQR: string;
}
